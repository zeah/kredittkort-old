...
final class Emkk_shortcode {
	...
	*/
	...
	public function shortcode_bestill($atts, $content = null) {
		...
		if ($meta) return '<div class="emkort-sokna emkort-sokna-bestill"><a rel="noopener" target="_blank" class="emkort-lenke emkort-sokna-lenke" href="'.esc_url($meta).'">Bestill Kortet</a></div>';
	}
	...
	*/
	private function make_kredittkort($post, $meta = null) {
		...
		$html .= '<div class="emkort-sokna"><a target="_blank" rel="noopener" class="emkort-lenke emkort-sokna-lenke" href="'.esc_url($sokna).'">Bestill Kortet</a></div>';
